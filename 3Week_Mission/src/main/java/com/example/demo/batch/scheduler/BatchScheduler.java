...
import com.example.demo.batch.job.makeRebateOrder.MakeRebateOrderItemJobConfig;
...
public class BatchScheduler {
    ...
    public void runJob() {
        ...
        try {
            ...
            jobLauncher.run(makeRebateOrderItemJobConfig.makeRebateOrderItemJob(makeRebateOrderItemStep1,initData), jobParameters);
